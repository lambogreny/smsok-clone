...
;
function extractPublicApiKey(req) {
    const authHeader = req.headers.get("authorization");
...
async function authenticatePublicApiKey(req) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["authenticateApiKey"])(req);
}
async function requireAdminPublicApiKey(req) {
    const user = await authenticatePublicApiKey(req);
    if (user.role !== "admin") {
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ApiError"](403, "Admin access required");
    }
    return user;
}
}),
...
"[project]/lib/actions/api-keys.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function createApiKey(userId, data) {
    const input = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$validations$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createApiKeySchema"].parse(data);
    // Limit: max 5 API keys per user
    const count = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].apiKey.count({
        where: {
            userId
        }
    });
    ...
    const apiKey = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].apiKey.create({
        data: {
            userId,
            name: input.name,
            key
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$cache$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["revalidatePath"])("/dashboard/api-keys");
...
async function getApiKeys(userId) {
    const keys = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].apiKey.findMany({
        where: {
            userId
        },
        select: {
...
async function toggleApiKey(userId, keyId) {
    ...
    const apiKey = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].apiKey.findFirst({
        where: {
            id: keyId,
            userId
        }
    ...
    const updated = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].apiKey.update({
        where: {
            id: keyId
        },
        data: {
...
async function deleteApiKey(userId, keyId) {
    ...
    if (!apiKey) throw new Error("ไม่พบ API Key");
    await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].apiKey.delete({
        where: {
            id: keyId
        }
    });
...
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["registerServerReference"])(createApiKey, "6049e726f40c565bb0202c1dcb2c6bfed28b21cf3f", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["registerServerReference"])(getApiKeys, "40c130a1f7eabcd16bcdf9b7a3cb16946cca9a4560", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["registerServerReference"])(toggleApiKey, "60558521bb83a761aaf79513c3bbe89799a548050e", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["registerServerReference"])(deleteApiKey, "603b9d37435791c09d34f72e673b96908b52dd0a39", null);
}),
...
"[project]/app/api/v1/api-keys/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$actions$2f$api$2d$keys$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/actions/api-keys.ts [app-route] (ecmascript)");
...
async function GET(req) {
    try {
        const user = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$key$2d$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["authenticatePublicApiKey"])(req);
        const keys = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$actions$2f$api$2d$keys$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getApiKeys"])(user.id);
...
async function POST(req) {
    try {
        const user = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$key$2d$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["authenticatePublicApiKey"])(req);
        const limit = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$rate$2d$limit$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["checkRateLimit"])(user.id, "apikey");
        if (!limit.allowed) return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$rate$2d$limit$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["rateLimitResponse"])(limit.resetIn);
        const body = await req.json();
        const input = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$validations$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createApiKeySchema"].parse(body);
        const apiKey = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$actions$2f$api$2d$keys$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createApiKey"])(user.id, input);
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["apiResponse"])(apiKey, 201);
    } catch (error) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["apiError"])(error);
    }
}
...
//# sourceMappingURL=%5Broot-of-the-server%5D__d2f2e565._.js.map