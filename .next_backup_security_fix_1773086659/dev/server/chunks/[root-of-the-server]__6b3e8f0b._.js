...
async function GET(req) {
    try {
        ...
        const [userData, recentMessages, recentTopups] = await Promise.all([
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].user.findUnique({
                where: {
                    id: user.id
                },
                select: {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].transaction.findMany({
                where: {
                    userId: user.id,
                    status: "verified"
                },
        ...
        const items = [
            ...recentMessages.map((m)=>({
                    ...
                    message: m.status === "sent" || m.status === "delivered" ? `ส่ง SMS ถึง ${m.recipient} สำเร็จ` : m.status === "failed" ? `ส่ง SMS ถึง ${m.recipient} ล้มเหลว` : `กำลังส่ง SMS ถึง ${m.recipient}`,
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["apiError"])(e);
    }
}
}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__6b3e8f0b._.js.map