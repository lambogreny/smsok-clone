...
"[project]/lib/actions/api-keys.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";

/* __next_internal_action_entry_do_not_use__ [{"40c130a1f7eabcd16bcdf9b7a3cb16946cca9a4560":"getApiKeys","603b9d37435791c09d34f72e673b96908b52dd0a39":"deleteApiKey","6049e726f40c565bb0202c1dcb2c6bfed28b21cf3f":"createApiKey","60558521bb83a761aaf79513c3bbe89799a548050e":"toggleApiKey"},"",""] */ __turbopack_context__.s([
    "createApiKey",
    ()=>createApiKey,
    "deleteApiKey",
    ()=>deleteApiKey,
...
function generateApiKey() {
    return "sk_live_" + (0, __TURBOPACK__imported__module__$5b$externals$5d2f$crypto__$5b$external$5d$__$28$crypto$2c$__cjs$29$__["randomBytes"])(32).toString("hex");
}
async function createApiKey(userId, data) {
    const input = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$validations$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["createApiKeySchema"].parse(data);
    // Limit: max 5 API keys per user
    const count = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].apiKey.count({
        where: {
            userId
        }
    });
    ...
    const apiKey = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].apiKey.create({
        data: {
            userId,
            name: input.name,
            key
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$cache$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["revalidatePath"])("/dashboard/api-keys");
...
async function getApiKeys(userId) {
    const keys = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].apiKey.findMany({
        where: {
            userId
        },
        select: {
...
async function toggleApiKey(userId, keyId) {
    ...
    const apiKey = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].apiKey.findFirst({
        where: {
            id: keyId,
            userId
        }
    ...
    const updated = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].apiKey.update({
        where: {
            id: keyId
        },
        data: {
...
async function deleteApiKey(userId, keyId) {
    ...
    if (!apiKey) throw new Error("ไม่พบ API Key");
    await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].apiKey.delete({
        where: {
            id: keyId
        }
    });
...
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(createApiKey, "6049e726f40c565bb0202c1dcb2c6bfed28b21cf3f", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(getApiKeys, "40c130a1f7eabcd16bcdf9b7a3cb16946cca9a4560", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(toggleApiKey, "60558521bb83a761aaf79513c3bbe89799a548050e", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(deleteApiKey, "603b9d37435791c09d34f72e673b96908b52dd0a39", null);
}),
"[project]/.next-internal/server/app/(dashboard)/dashboard/api-keys/page/actions.js { ACTIONS_MODULE0 => \"[project]/lib/actions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE1 => \"[project]/lib/actions/api-keys.ts [app-rsc] (ecmascript)\" } [app-rsc] (server actions loader, ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$actions$2f$api$2d$keys$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/actions/api-keys.ts [app-rsc] (ecmascript)");
;
;
;
;
...
"[project]/.next-internal/server/app/(dashboard)/dashboard/api-keys/page/actions.js { ACTIONS_MODULE0 => \"[project]/lib/actions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE1 => \"[project]/lib/actions/api-keys.ts [app-rsc] (ecmascript)\" } [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "008f729691ced488406cb11eb9f1b5d29439616cb6",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["logout"],
    "40c130a1f7eabcd16bcdf9b7a3cb16946cca9a4560",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$actions$2f$api$2d$keys$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getApiKeys"],
    "603b9d37435791c09d34f72e673b96908b52dd0a39",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$actions$2f$api$2d$keys$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["deleteApiKey"],
    "6049e726f40c565bb0202c1dcb2c6bfed28b21cf3f",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$actions$2f$api$2d$keys$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["createApiKey"],
    "60558521bb83a761aaf79513c3bbe89799a548050e",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$actions$2f$api$2d$keys$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["toggleApiKey"]
]);
var __TURBOPACK__imported__module__$5b$project$5d2f2e$next$2d$internal$2f$server$2f$app$2f28$dashboard$292f$dashboard$2f$api$2d$keys$2f$page$2f$actions$2e$js__$7b$__ACTIONS_MODULE0__$3d3e$__$225b$project$5d2f$lib$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29222c$__ACTIONS_MODULE1__$3d3e$__$225b$project$5d2f$lib$2f$actions$2f$api$2d$keys$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$2922$__$7d$__$5b$app$2d$rsc$5d$__$28$server__actions__loader$2c$__ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i('[project]/.next-internal/server/app/(dashboard)/dashboard/api-keys/page/actions.js { ACTIONS_MODULE0 => "[project]/lib/actions.ts [app-rsc] (ecmascript)", ACTIONS_MODULE1 => "[project]/lib/actions/api-keys.ts [app-rsc] (ecmascript)" } [app-rsc] (server actions loader, ecmascript) <locals>');
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/actions.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$actions$2f$api$2d$keys$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/actions/api-keys.ts [app-rsc] (ecmascript)");
}),
];

//# sourceMappingURL=_3f14d475._.js.map