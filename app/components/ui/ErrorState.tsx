  ...
  return (
    ...
    >
      ...
      {onRetry && (
        <motion.button
          onClick={onRetry}
          className="bg-transparent border border-[var(--border-default)] text-[var(--text-primary)] rounded-lg hover:border-[rgba(var(--accent-rgb),0.3)] hover:bg-[rgba(var(--accent-rgb),0.04)] inline-flex items-center gap-2 px-5 py-2.5 text-sm font-medium"
