      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="glass p-10 animate-fade-in" style={{ animationDelay: "0.1s" }}>
          <div className="text-center mb-8">
            ...
            <p className="text-white/40 text-sm mt-1">เข้าสู่ระบบเพื่อจัดการ SMS</p>
          </div>
          ...
          <form action={formAction} className="space-y-5">
            ...
            <div>
              <label className="block text-xs text-white/50 uppercase tracking-wider mb-2">รหัสผ่าน</label>
              <input
        ...
        {/* Testimonial */}
        <div className="mt-6 glass p-5 text-center animate-fade-in" style={{ animationDelay: "0.2s" }}>
          <p className="text-sm text-white/40 italic">&ldquo;ส่ง SMS 10,000+ ข้อความในคลิกเดียว&rdquo;</p>
          <p className="text-xs text-white/25 mt-2">ธุรกิจกว่า 500+ ไว้วางใจ</p>
        </div>
      </div>
    </div>
  );
