  ...
  return (
    <Sheet
      ...
      onOpenChange={(nextOpen) => {
        if (!nextOpen && !getStoredPreferences()) {
          return;
        }
        setOpen(nextOpen);
      }}
    >
      <SheetContent
        ...
        className="inset-x-0 bottom-0 mx-auto w-full max-w-5xl rounded-t-[28px] border border-[var(--border-default)] bg-[var(--bg-surface)] px-0 pb-0 pt-0 text-[var(--text-primary)] shadow-[0_-24px_80px_rgba(0,0,0,0.45)]"
      >
        <SheetHeader className="border-b border-[var(--border-default)] px-6 py-5 sm:px-8">
          <div className="flex items-start gap-4">
            ...
            <div className="space-y-1">
              ...
              <SheetDescription className="max-w-3xl text-[13px] leading-6 text-[var(--text-secondary)]">
        ...
        <SheetFooter className="border-t border-[var(--border-default)] bg-[rgba(255,255,255,0.02)] px-6 py-4 sm:flex-row sm:items-center sm:justify-between sm:px-8">
