...
export const TAG_COLORS: TagColor[] = [
  ...
  { name: "sky",     hex: "#00E2B5", dot: "bg-[var(--accent)]",   bg: "bg-[rgba(var(--accent-rgb),0.08)]",  text: "text-[var(--accent)]", border: "border-[rgba(var(--accent-rgb),0.2)]",  activeBg: "bg-[rgba(var(--accent-rgb),0.2)]" },
