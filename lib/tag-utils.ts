...
export const TAG_COLORS: TagColor[] = [
  ...
  { name: "cyan",    hex: "#00FFA7", dot: "bg-[var(--accent)]",   bg: "bg-[rgba(var(--accent-rgb),0.08)]", text: "text-[var(--accent)]", border: "border-[rgba(var(--accent-rgb),0.2)]", activeBg: "bg-[rgba(var(--accent-rgb),0.2)]" },
  ...
  { name: "sky",     hex: "#00E2B5", dot: "bg-[#00E2B5]",   bg: "bg-[rgba(0,226,181,0.08)]",  text: "text-[#00E2B5]", border: "border-[rgba(0,226,181,0.2)]",  activeBg: "bg-[rgba(0,226,181,0.2)]" },
